...
class eno_dashboard_Settings {
    ...
    private function menu_settings() {
        return apply_filters(
            ...
            array(
                ...
                'page_title'  => __( 'Plugin Settings', 'eno-dashboard' ),
                'menu_title'  => __( 'Plugin Settings', 'eno-dashboard' ),
    ...
    private function settings_fields() {
        ...
        $settings['extra'] = array(
            'title'       => __( 'Extra', 'eno-dashboard' ),
            'description' => __( 'These are some extra input fields that maybe aren\'t as common as the others.', 'eno-dashboard' ),
            'fields'      => array(
                array(
                    'id'          => 'number_field',
    ...
    public function settings_page() {
        ...
        $html .= '<h2>' . __( 'Plugin Settings', 'eno-dashboard' ) . '</h2>' . "\n";
