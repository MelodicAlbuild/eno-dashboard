 ...
 * Settings class.
 */
class eno_dashboard_Settings {

	/**
	 * The single instance of eno-dashboard_Settings.
	 *
	 * @var     object
	 * @access  private
	 * @since   1.0.0
	...
	public function add_settings_link( $links ) {
		$settings_link = '<a href="options-general.php?page=' . $this->parent->_token . '_settings">' . __( 'Settings', 'eno-dashboard' ) . '</a>';
	...
	public function settings_page() {
		...
		$html      = '<div class="wrap" id="' . $this->parent->_token . '_settings">' . "\n";
			$html .= '<h2>' . __( 'ENO Dashboard Settings', 'eno-dashboard' ) . '</h2>' . "\n";
		...
		if ( is_array( $this->settings ) && 1 < count( $this->settings ) ) {
			...
			$html .= '<form method="post" action="options.php" enctype="multipart/form-data">' . "\n";
				...
				$html     .= '<p class="submit">' . "\n";
					...
					$html .= '<input name="Submit" type="submit" class="button-primary" value="' . esc_attr( __( 'Save Settings', 'eno-dashboard' ) ) . '" />' . "\n";
				$html     .= '</p>' . "\n";
			$html         .= '</form>' . "\n";
		$html             .= '</div>' . "\n";
	...
	/**
	 * Main eno-dashboard_Settings Instance
	 *
	 * Ensures only one instance of eno-dashboard_Settings is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see eno-dashboard()
	 * @param object $parent Object instance.
	 * @return object eno-dashboard_Settings instance
	 */
	...
	public function __clone() {
		_doing_it_wrong( __FUNCTION__, esc_html( __( 'Cloning of eno-dashboard_API is forbidden.' ) ), esc_attr( $this->parent->_version ) );
	} // End __clone()
	...
	public function __wakeup() {
		_doing_it_wrong( __FUNCTION__, esc_html( __( 'Unserializing instances of eno-dashboard_API is forbidden.' ) ), esc_attr( $this->parent->_version ) );
	} // End __wakeup()
